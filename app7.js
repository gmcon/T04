...
function preload() {
  ...
  cartaReverso = loadImage('rec/imagenes/back.png'); // Imagen de la parte trasera
  for (let i = 1; i <= 4; i++) {
    let img = loadImage(`rec/imagenes/front${i}.png`); // Imagenes de las cartas (front1.png, front2.png, etc.)
